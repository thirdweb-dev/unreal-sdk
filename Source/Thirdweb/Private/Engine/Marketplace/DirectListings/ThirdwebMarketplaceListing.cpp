...
TSharedPtr<FJsonObject> FThirdwebMarketplaceCreateListingRequest::ToJson() const
{
...
TSharedPtr<FJsonObject> FThirdwebMarketplaceUpdateListingRequest::ToJson() const
{
